...
frappe.ui.form.on("Print Format Source Settings", {
    fetch_files: function (frm) {
        frappe.call({
            method: "print_format.print_format.doctype.print_format_source_settings.print_format_source_settings.get_gitInfo",
            args: {},
            callback: function (r) {
                if (r.message) {
