...
import re
import click
import werkzeug.routing.exceptions # type: ignore
from werkzeug.routing import Rule # type: ignore

from frappe.website.page_renderers.document_page import DocumentPage
from frappe.website.page_renderers.list_page import ListPage
from print_format.page_renderers.template_page import NotFoundPage
...
from print_format.page_renderers.template_page import DesignerPage
...
class PathResolver:
	...
	def resolve(self):
		...
		if endpoint == "app":
			return endpoint, DesignerPage(endpoint, self.http_status_code)
