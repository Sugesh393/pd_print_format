...
class DesignerPage(BaseTemplatePage):
	...
	def update_context(self):
		...
		if self.pymodule_name:
			...
			data = self.run_pymodule_method("get_print_context")
...
def get_start_folders():
    return frappe.local.flags.web_pages_folders or ("page_renderers", "templates/pages")

class NotFoundPage(DesignerPage):
	def __init__(self, path, http_status_code=None):
